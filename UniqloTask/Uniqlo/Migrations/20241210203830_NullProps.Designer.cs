...
namespace Uniqlo.Migrations
{
    ...
    [Migration("20241210203830_NullProps")]
    partial class NullProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uniqlo.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Uniqlo.Models.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Uniqlo.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    ...
                    b.HasOne("Uniqlo.Models.Size", null)
                        .WithMany()
